// Seed data for Phase 1 (UI-only). Future Phase 2 will replace with Supabase rows
// whose JSON shapes match short_json / full_json / skill_levels exactly.
...
export const SEED_COMPANIES = [
  {
    ...
    full_json: {
      ...
      cybersecurity_posture:
        "ISO 27001; SOC 2; Global cyber defense centers",
      partnership_ecosystem:
        "Microsoft; SAP; Oracle; Google; AWS; Salesforce",
      tech_adoption_rating:
        "High, Industry Leader; Top-tier among peers",
    },
    skill_levels: [
